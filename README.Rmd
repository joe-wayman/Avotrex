...
As this is version 1.3.1 of the package, it is possible that there are some bugs in places. Please report any issues to us via GitHub.
...
avotrex = AvotrexPhylo, PER = 0.2, 
PER_FIXED = 0.75, mindist = 0.1, 
ord = FALSE, tax = tax, 
